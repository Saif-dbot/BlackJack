"""Q-Learning agent with card counting."""
...
class QLearningCountAgent(AgentBase):
    """Q-Learning agent with Hi-Lo card counting.
    
    Extends basic Q-Learning with true count observation.
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        """Initialize Q-Learning agent with counting.
    ...
    def update(
        ...
        **kwargs: Any
        ...
        """Update Q-value using Q-Learning with card counting.
